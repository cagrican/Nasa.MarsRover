...
namespace Nasa.MarsRover.Commands
{
    public class RotateLeftCommand:ICommand
    {
        ...
        public RotateLeftCommand(IMarsRoverService marsRoverService, IDirectionManagerStrategy directionManagerStrategy)
        {
        ...
        public void Execute()
        {
            ...
            roverPosition.Direction = _directionManagerStrategy.RotateLeft(roverPosition.Direction);
